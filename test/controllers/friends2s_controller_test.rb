...
class Friends2sControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create friends2" do
    assert_difference('Friends2.count') do
      post friends2s_url, params: { friends2: { email: @friends2.email, first_name: @friends2.first_name, last_name: @friends2.last_name, phone: @friends2.phone } }
    end
  ...
  test "should update friends2" do
    patch friends2_url(@friends2), params: { friends2: { email: @friends2.email, first_name: @friends2.first_name, last_name: @friends2.last_name, phone: @friends2.phone } }
